...
train = schnetpack.data.AtomsData('Data/dataset_10_12_train_combined.db', available_properties=['KD'],
...
bench = schnetpack.data.AtomsData('Data/dataset_10_12_test.db', available_properties=['KD'],
                                  environment_provider=schnetpack.environment.TorchEnvironmentProvider(10.,
                                                                                                       torch.device(
                                                                                                           'cpu')))
if (len(bench) == 0):
